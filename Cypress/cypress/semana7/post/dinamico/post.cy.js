...
describe('Crear post Con titulo, contenido, titulo de metadata de 200 caracteres y descripción de metadata', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
...
describe('Crear Post Con titulo, contenido, titulo de metadata y descripción de metadata de mas de 500 caracteres', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
...
describe('Crear post Con titulo, contenido, titulo de metadata, descripción de metadata y URL no válida', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
...
describe('Crear post Con titulo, contenido, titulo de metadata, descripción de metadata y URL válida', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
...
describe('crear post Con título, contenido y título de twitter y descripción de 0 caracteres', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
...
describe('crear post Con título, contenido y título de twitter de 200 caracteres', () => {
  it('passes', () => {
    loginPage.defaultLogin();
    utils.goToCreatePost();
